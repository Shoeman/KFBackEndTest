import {processOutages} from "../../src";
...
describe('processOutages', () => {
    ...
    it('should retrieve and filter outages', async function () {
        ...
        mockGetOutages.mockResolvedValueOnce(mockOutages);

        const result = await processOutages();
        await expect(result).toEqual(expectedOutages);
    });
});